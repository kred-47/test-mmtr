...
const CardList = (props) => {
    ...
    const {addElements, arrayOfLists, onClickToggleElement, onClickColorTheme} = props;  // передаю массив колонок, добавление элементов, ф-я нажатия галочки
    const [columns, setColumns] = useState(arrayOfLists); // состояние массива с элементами (карточки)


    useEffect(() => {   // ?????????
        setColumns(arrayOfLists)
    }, [arrayOfLists])
